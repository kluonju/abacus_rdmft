...
* test_neighbour: obtain information of neighboring atoms (for LCAO basis only), please specify a positive search_radius manually)";
    ...
    }
    {
        ...
        item.annotation = "the energy solver: ksdft, sdft, ofdft, tdofdft, tddft, lj, dp, ks-lr, lr, rdmft";
        item.category = "System variables";
        item.type = "String";
...
* rdmft: reduced density matrix functional theory (modular RDMFT esolver))";
        item.default_value = "ksdft";
        read_sync_string(input.esolver_type);
        item.check_value = [](const Input_Item& item, const Parameter& para) {
            const std::vector<std::string> esolver_types = { "ksdft", "sdft", "ofdft", "tdofdft", "tddft", "lj", "dp", "nep", "lr", "ks-lr", "rdmft" };
