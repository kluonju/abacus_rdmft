...
struct RDMFTConfig
{
    ...
    /// Alternating orbital CG/L-BFGS: enable pairwise level-shift preconditioner on rotations.
    bool orb_cg_precond = true;
    /// Alternating orbital CG/L-BFGS: level-shift δ in 1/(|ε_i-ε_j|+δ). <=0 uses auto δ.
